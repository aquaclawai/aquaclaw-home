...
export default function Footer({ lang, dict }: FooterProps) {
  return (
    <footer className="bg-muted/50 border-t border-muted mt-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a
                  href="https://discord.gg/aquaclaw"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-foreground/70 hover:text-primary transition-colors py-1"
                >
          ...
          <div>
            ...
            <input
              ...
              disabled
              className="w-full px-3 py-2 rounded-md bg-background border border-muted text-sm opacity-60 cursor-not-allowed"
            />
            <button
              disabled
              className="mt-2 w-full px-3 py-2 rounded-md bg-primary/30 text-primary-dark text-sm font-medium cursor-not-allowed"
            >
