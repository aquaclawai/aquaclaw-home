...
- [ ] **Phase 3: Navigation Shell** - Fixed nav bar, mobile hamburger menu, footer, and 404 page completing the site shell
- [ ] **Phase 4: Diary Section** - Fully browsable diary listing and detail pages with MDX content pipeline
