...
- [x] **FOUN-02**: i18n routing architecture established (`app/[lang]/`) with next-intl — English only, strings externalized
- [x] **FOUN-03**: Content storage structure defined — MDX files with frontmatter in `/content/` directories
- [x] **FOUN-04**: Content access layer (`lib/content/`) with typed functions for reading/listing content
